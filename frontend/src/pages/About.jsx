  ...
  return (
    <div>
      ...
      <div className='flex flex-col flex-row mb-20'>
        <div className='border px-10 md:px-15 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-blue-400 hover:text-white transition-all duration-300 text-gray-600 cursor-pointer '>
          <b>EFFICIENCY:</b>
