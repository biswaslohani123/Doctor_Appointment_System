...
const TopDoctors = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-500 md:mx-10">
        ...
        {doctors.slice(0, 10).map((doctor, index) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="font-medium text-gray-800 mt-2">{doctor.name}</p>
      ...
      <button onClick={() => {navigate('/doctors'); scrollTo(0,0)}} className="bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10 hover:bg-blue-100 transition-colors">
        More
      </button>
    </div>
  );
