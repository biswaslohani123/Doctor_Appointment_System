...
const AddDoctor = () => {
  return (
    <form className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-8 border-gray-50 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll  ">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
          ...
          <div className="w-full lg:flex-1 flex-col gap-4">
            ...
            <div className="flex-1 flex flex-col gap-1">
                <p>Address</p>
                <input className="border border-gray-300 rounded px-3 py-2"  type="text" placeholder="address-1"  required/>
                <input  className="border border-gray-300 rounded px-3 py-2"  type="text" placeholder="address-2"  required/>
            </div>
          </div>
         ...
         <div>
              ...
              <textarea className="w-full px-4 pt-2 border border-gray-300 rounded " type="text" rows={5} placeholder="write about Doctor" required />
            </div> 

            <button className="bg-blue-400 px-10 py-3 mt-4 text-white rounded-full cursor-pointer ">Add Doctor</button>
      </div>
    </form>
  );
};
