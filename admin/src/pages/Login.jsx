  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      if (state === "Admin") {
        ...
        const { data } = await axios.post(`${backendUrl}/api/doctor/login-doc`, {
          email,
          password,
        });
        ...
        if (data.success) {
          ...
          navigate("/doctor-dashboard"); // Adjust route as needed
        } else {
          toast.error(data.message);
        }
      }
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex items-center justify-center px-8 lg:px-16">
        <div className="w-full max-w-md">
          <h1 className="text-4xl font-semibold text-gray-800 mb-12">{state} Login</h1>
